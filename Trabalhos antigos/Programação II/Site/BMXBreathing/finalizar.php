<?php
    ...
    if(isset($_POST['comprar'])){
        ...
        if(!isset($_COOKIE['email'])){
            ...
            $erros = array();
            if(!isset($_POST['correio'])){
                $erros[] = "Selecione o frete!";
            }else{
                $passo = 4;
                require_once("conexao.php");
                $emailCookie = $_COOKIE['email'];
                ...
                $cliente = mysqli_fetch_array($busca);
                $cpf = $cliente['cpf'];
                $busca = mysqli_query($conexao, "DELETE FROM Carrinho WHERE cpfCli = '$cpf'");
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div id="produto">
                            <table id="tableCarrinhoSuperior" width="100%" border="1" bgcolor=#c1c1c1>   
                                <tr align="center">    
                                    <td><h4><img src="Imagens/carrinho.png" alt="Carrinho" class id="carrinhoFinal">FINALIZAÇÃO</h4></td>
                            ...
                            <table id="tableCarrinho" width="100%" border="1" bgcolor=#c1c1c1>
                                ...
                                ?>
                                <tr>
                                    <td>CEP: <?php echo $cliente['cep'];?>
                                    <br>Rua: <?php echo $cliente['rua'];?>
                                    <br>Numero: <?php echo $cliente['numero'];?>
                                    <br>Complemento: <?php echo $cliente['complemento'];?>
                                    <br>Bairro: <?php echo $cliente['bairro'];?>
                                    <br>Cidade: <?php echo $cliente['cidade'];?>
                                    <br>Estado: <?php echo $cliente['estado'];?></td>
                                </tr>
                            </table>
