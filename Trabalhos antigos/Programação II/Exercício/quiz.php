...
<h2>Teste seus conhecimentos sobre linguagens para a Web!</h2>
<br><br>
<form name="teste" action="respostas.php" method="post">
    Seu nome: <input type="text" name="nome"> Seu e-mail: <input type="email" name="email" size="50">
    <br><br>
    <fieldset>
        <legend>Questão 1</legend>
        Sigla da linguagem de marcação de hipertexto padrão da Web: <input type="text" name="q1">
    </fieldset>

    <fieldset>
        <legend>Questão 2</legend>
        Sigla da linguagem estilização de páginas padrão da Web: <input type="text" name="q2">
    </fieldset>
    <fieldset>
