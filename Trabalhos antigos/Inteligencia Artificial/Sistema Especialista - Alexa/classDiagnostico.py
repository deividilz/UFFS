...
class Diagnostico():
	# metodo construtor
	def __init__(self):
		#RESPOSTAS DA REDE SEMÂNTICA
		self.resultado = ['aumente_volume', 'sem_alimentacao', 'desativa_mudo', 'conecta_wifi', 'baixo_wifi', 'longe', 'defeito_microfone', 'perfeito', 'defeito_audio', 'cadastre_dispositivo']
		self.pessoa = []
		self.db = []
